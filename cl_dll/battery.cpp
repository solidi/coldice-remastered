...
int CHudBattery::Draw(float flTime)
{
	...
	rc.top  += m_iHeight * ((float)(m_iBatMax-(fmin(m_iBatMax,m_iBat))) * fScale); // battery can go from 0 to m_iBatMax so * fScale goes from 0 to 1
#else
	rc.top  += m_iHeight * ((float)(100-(fmin(100,m_iBat))) * 0.01);	// battery can go from 0 to 100 so * 0.01 goes from 0 to 1
#endif
