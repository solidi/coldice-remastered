...
#define SNOWSPEED    100		// speed of snowflakes
...
void InitRain( void )
{
	...
	Rain.hsprRain = SPR_Load("sprites/rain.spr");
	Rain.hsprSnow = SPR_Load("sprites/snowflake.spr");
	Rain.hsprRipple = SPR_Load("sprites/ripple.spr");
...
void VectorTransform2(const vec_t *in1, float (*in2)[4], vec_t *out)
{
...
void SetPoint( float x, float y, float z, float (*matrix)[4])
{
	...
	VectorTransform2( point, matrix, result );
...
void DrawRain( void )
{
	...
	if( Rain.weatherMode == 0 ) // draw rain
	{
		...
		{
			Rain.hsprRain = SPR_Load("sprites/rain.spr");
			pTexture = gEngfuncs.GetSpritePointer( Rain.hsprRain );
		}
	...
	else	// draw snow
	{
		...
		{
			Rain.hsprSnow = SPR_Load("sprites/snowflake.spr");
			pTexture = gEngfuncs.GetSpritePointer( Rain.hsprSnow );
		}
...
void DrawFXObjects( void )
{
	...
	{
		Rain.hsprRipple = SPR_Load("sprites/ripple.spr");
		pTexture = gEngfuncs.GetSpritePointer( Rain.hsprRipple );
	}
