...
void ClientCommand( edict_t *pEntity )
{
	...
	else if ( FStrEq( pcmd, "help_server" )  )
	{
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_infiniteammo [0|1|2]\" - Infinite ammo ala CS 1.6\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"plumber\"\" - spawn with dual pipe wrenches\n");
	...
	else if ( FStrEq( pcmd, "help_server_more" )  )
	{
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"explosiveai\"\" - AI blows up when it cannot find its next task\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"itemsexplode\"\" - weapons and items react to explosions\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"notthebees\"\" - hornets spawn from a player or monster who was killed\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"dontshoot\"\" - firing any weapon will explode the player.\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_mutators \"999\"\" - start with 999 health and battery.\n");
