...
void ClientCommand( edict_t *pEntity )
{
	...
	else if ( FStrEq( pcmd, "help_server" )  )
	{
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_gamemode \"coldskull\"\" - collect all the cold skulls to win\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_gamemode \"teamplay\"\" - frag on teams\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"chaos\"\" - randomly selects three mutators every 30 seconds!\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"999\"\" - start with 999 health and battery.\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"astronaut\"\" - gravity is turned down\n");
	...
	else if ( FStrEq( pcmd, "help_server_more" )  )
	{
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"credits\"\" - show all contributors in an endless loop.\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"instagib\"\" - spawn with dual railguns that dole one hit kills\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"itemsexplode\"\" - weapons and items react to explosions\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"jack\"\" - we don't make it 'til you order it.\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"jeepathon\"\" - everyone is a jeep.\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"longjump\"\" - everyone receives a long jump module\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"loopback\"\" - teleport to the place of your last frag\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"notify\"\" - interrupt players with annoying chat notifications\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"slowbullets\"\" - bullets travel slowly to target\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"slowmo\"\" - everything is slowed down by half! (sp only!)\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"topsyturvy\"\" - everything is turned upside down (sp only!)\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"sv_mutators \"toilet\"\" - game is in the toilet, we ain't hurt nobody.\n");
