...
void ClientCommand( edict_t *pEntity )
{
	...
	else if ( FStrEq( pcmd, "help" ) || FStrEq( pcmd, "help_more" ) )
	{
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "See client_commands.txt in the game directory.\n" );
	}
	else if ( FStrEq( pcmd, "help_server" ) || FStrEq( pcmd, "help_server_more" ) || FStrEq( pcmd, "help_server_more_2" ) )
	{
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "See server_commands.txt in the game directory.\n" );
	}
#ifdef _DEBUG
			...
			while ( pPlayerItem )
			{
				...
				if ( gun && gun->UseDecrement() )
				{
					...
					if ( II.iId >= 0 && II.iId < MAX_WEAPONS )
					{
						...
						item->fuser4					= gun->m_flSmashStart;
