...
void ClientCommand( edict_t *pEntity )
{
	...
	else if ( FStrEq( pcmd, "help_server" )  )
	{
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"mp_allowrunes [0|1|2]\" - Allow powerup runes on server, > 1, more runes spawn\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"arena\" - 1 on 1 arena\n");
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"lms\" - battle royale with a shrinking safe zone\n");
		...
		ClientPrint( &pEntity->v, HUD_PRINTCONSOLE, "\"coldspot\" - stay in a rotating zone to score points\n");
