...
const char *CBreakable::pSpawnObjects[] =
{
	...
	"weapon_nuke",		// 36
	"weapon_deagle",	// 37
	"weapon_dual_deagle",	// 38
	"weapon_dual_rpg",	// 39
	"weapon_dual_smg",	// 40
	"weapon_dual_wrench",	// 41
	"weapon_dual_usas",	// 42
	"weapon_freezegun",	// 43
	"weapon_wrench", // 44
	"weapon_dual_mag60",	// 45
	"weapon_rocketcrowbar",	// 46
	"weapon_dual_railgun",	// 47
	"weapon_gravitygun",	// 48
	"weapon_flamethrower",	// 49
	"weapon_dual_flamethrower",	// 50
	"weapon_ashpod",	// 51
	"weapon_sawedoff",	// 52
	"weapon_dual_sawedoff",	// 53
	"weapon_dual_chaingun",	// 54
	"weapon_dual_hornetgun",	// 55
	"weapon_fingergun",	// 56
	"weapon_zapgun",	// 57
	"weapon_dual_glock",	// 58
	"weapon_vice",	// 59
	"weapon_egon",	// 60
	"weapon_gauss",	// 61
	"weapon_crowbar",	// 62
