...
cvar_t	chaosfilter = {"sv_chaosfilter","oldtime;sildenafil;inverse;itemsexplode", FCVAR_SERVER };
...
cvar_t	pointlimit = {"mp_pointlimit","100", FCVAR_SERVER };
