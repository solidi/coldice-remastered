...
DLL_GLOBAL const char *g_MutatorJeepAThon = "jeepathon";
DLL_GLOBAL const char *g_MutatorToilet = "toilet";
DLL_GLOBAL const char *g_MutatorRicochet = "ricochet";
DLL_GLOBAL const char *g_MutatorCredits = "credits";
