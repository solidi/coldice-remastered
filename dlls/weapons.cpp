...
BOOL CWeaponBox::PackWeapon( CBasePlayerItem *pWeapon )
{
	...
	else if (pWeapon->m_iId == WEAPON_CHAINGUN)
	{
		...
		pev->sequence = ((WEAPON_CHAINGUN - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_SNIPER_RIFLE)
	{
		...
		pev->sequence = ((WEAPON_SNIPER_RIFLE - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_CANNON)
	{
		...
		pev->sequence = ((WEAPON_CANNON - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_RAILGUN)
	{
		...
		pev->sequence = ((WEAPON_RAILGUN - 1) * 2) + floating;
	}
	else if (pWeapon->m_iId == WEAPON_WRENCH)
	{
		SET_MODEL( ENT(pev), "models/w_weapons.mdl");
		pev->body = WEAPON_WRENCH - 1;
		pev->sequence = ((WEAPON_WRENCH - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_FREEZEGUN)
	{
		...
		pev->sequence = ((WEAPON_FREEZEGUN - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_ROCKETCROWBAR)
	{
		...
		pev->sequence = ((WEAPON_ROCKETCROWBAR - 1) * 2) + floating;
	}
	...
	else if (pWeapon->m_iId == WEAPON_GRAVITYGUN)
	{
		...
		pev->sequence = ((WEAPON_GRAVITYGUN - 1) * 2) + floating;
	}
