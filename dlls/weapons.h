...
#define ITEM_FLAG_NODROP			32
#define ITEM_FLAG_SINGLE_HAND		64
...
public:
	...
	void DefaultHolster( int iAnim, int body = 0 );
...
extern void RadiusDamage( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, float flRadius, int iClassIgnore, int bitsDamageType, BOOL ignoreAttacker = FALSE );
...
class CFingerGun : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
